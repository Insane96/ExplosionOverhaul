...
import insane96mcp.explosionoverhaul.mixin.ExplosionMixin;
...
public class BaseFeature extends Feature {
	...
	public void replaceExplosionWithITRExplosion(ExplosionEvent.Start event) {
		...
		ISOExplosion.explode(level, ((ExplosionAccessor) e).getSource(), ((ExplosionAccessor) e).getDamageSource(), ((ExplosionAccessor) e).getDamageCalculator(), e.center().x, y, e.center().z, e.radius(), ((ExplosionAccessor) e).getFire(), e.getBlockInteraction(), true);
	}
